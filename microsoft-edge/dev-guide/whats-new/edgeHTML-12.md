...
Mit der Objekt-Echtzeitkommunikation \ (ORTC \) können Medien \ (Audio und/oder Video \) in Echtzeit direkt zwischen Webbrowsern, mobilen Geräten und Servern über systemeigene JavaScript-APIs gestreamt (gesendet und empfangen \) werden.  Weitere Informationen zu ORTC in Microsoft Edge finden Sie im Entwicklerhandbuch zum Thema [Objekt RTC-API](https://ortc.org) .  
