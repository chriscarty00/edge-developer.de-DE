...
:::image type="complex" source="../../media/2020/05/keyboard-shortcut.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/keyboard-shortcut.msft.png":::
   The Microsoft Edge DevTools in high contrast mode  
:::image-end:::  
...
:::image type="complex" source="../../media/2020/05/surface-duo-emulator.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/surface-duo-emulator.msft.png":::
...
:::image type="complex" source="../../media/2020/05/edge-inspect.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/edge-inspect.msft.png":::
...
:::image type="complex" source="../../media/2020/05/drawer-83.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/drawer-83.msft.gif":::
...
:::image type="complex" source="../../media/2020/05/drawer-84.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/drawer-84.msft.gif":::
...
:::image type="complex" source="../../media/2020/05/screencasting-nav.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/screencasting-nav.msft.png":::
...
:::image type="complex" source="../../media/2020/05/network-details.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/network-details.msft.png":::
...
:::image type="complex" source="../../media/2020/05/issues.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/issues.msft.png":::
...
The **Inspect Mode** tooltip now indicates whether the element has an accessible [name and role][WebhintHintsAxeNameRoleValue] and is [keyboard-focusable][WebhintHintsAxeKeyboard].  

<!--todo:  add link inspect mode tooltip (WebdevCls) when section is live  -->  
<!--todo:  add link name and role (WebdevLabelsText) when section is live  -->  
<!--todo:  add link keyboard-focusable (WebdevControlFocus) when section is live  -->  

:::image type="complex" source="../../media/2020/05/a11y.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/a11y.msft.png":::
...
:::image type="complex" source="../../media/2020/05/tbt.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/tbt.msft.png":::
...
:::image type="complex" source="../../media/2020/05/cls.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/cls.msft.png":::
...
:::image type="complex" source="../../media/2020/05/resolved.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/resolved.msft.png":::
...
:::image type="complex" source="../../media/2020/05/fulfilled.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/fulfilled.msft.png":::
...
:::image type="complex" source="../../media/2020/05/revert.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/revert.msft.png":::
...
:::image type="complex" source="../../media/2020/05/image-preview.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/image-preview.msft.png":::
...
[CSS Color Module Level 4][CSSWGDraftsColor4Changes3] specifies that color functions, such as `rgb()`, should support space-separated arguments.  For example, `rgb(0, 0, 0)` is equivalent to `rbg(0 0 0)`.  
...
:::image type="complex" source="../../media/2020/05/color.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/color.msft.png":::
...
:::image type="complex" source="../../media/2020/05/properties.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/properties.msft.png":::
...
:::image type="complex" source="../../media/2020/05/app-shortcuts.msft.png" alt-text="The Microsoft Edge DevTools in high contrast mode" lightbox="../../media/2020/05/app-shortcuts.msft.png":::
