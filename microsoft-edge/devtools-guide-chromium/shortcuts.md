...
You can also find shortcuts in tooltips. Hover over a UI element of DevTools to display the tooltip. If the element has a shortcut, the tooltip includes it.
