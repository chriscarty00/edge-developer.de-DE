...
---
# <a name="progressive-web-apps-on-windows-overview"></a>Progressive Web Apps on Windows Overview  
...
Erstellen Sie \(oder konvertieren\) Ihre vorhandene Website in PWA, um Ihr Engagement mit Ihren Benutzern zu verbessern.  Zu den Verbesserungen gehören Pushbenachrichtigungen, app-like integration und offline support.  Erstellen Sie weiterhin Ihre Zielgruppe im geöffneten Web, damit Benutzer Ihre PWA Suchen und Teilen von Links ermitteln können.  Das Beste ist, dass Ihre App mithilfe des Webservercodes aktualisiert wird.  

## <a name="pwas-on-microsoft-edge-chromium"></a>PWAs on Microsoft Edge (Chromium)  
...
*   Ermöglicht Es Ihren Benutzern, Ihre App direkt über den Browser zu installieren.  
*   Ermöglicht Benutzern die Installation Ihrer App ohne Store Bereitstellung oder Registrierung.  
    
Desktop-PWAs werden auf allen Plattformen unterstützt, Microsoft Edge \(Chromium\) verfügbar ist. Microsoft Edge \(Chromium\) ist unter Windows 7, Windows 10 und macOS verfügbar.  Die folgenden Vorteile sind enthalten.  
...
*   Apps können auch im Menü apps installiert, ausgeführt **und Einstellungen**  >  **verwaltet** werden.  
...
*   Webbenachrichtigungen sind in das Benachrichtigungssystem Windows integriert  
...
> [!NOTE]
> Weitere Informationen zu PWA, bevorstehenden Features und kurzen Demos finden Sie unter [Build 2020 PWA Session][BuildVideo]. 

## <a name="requirements"></a>Anforderungen  

Um als PWA ausführen zu können, sollte Ihre vom Server gehostete Web-App die folgenden Mindestanforderungen enthalten.  
...
:::row:::
   ...
   :::column-end:::
   :::column span="2":::
      Schützt Ihre Benutzer, indem sie eine sichere Verbindung für die Server- oder App-Kommunikation bereitstellen.  Service Workers und andere PWA funktionieren nur mit Webressourcen, die über eine sichere Verbindung \(oder aus `localhost` Debugzwecken) bedient werden\).  
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="1":::
...
Um ein großartiges PWA, muss Ihre App auch die folgenden Anforderungen erfüllen.  
...
:::row:::
   ...
   :::column-end:::
   :::column span="2":::
      Stellen Sie PWA, indem Sie [tests][MicrosoftDeveloperEdgeToolsRemote] in verschiedenen Browsern und Umgebungen durchführen.  
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="1":::
   ...
   :::column span="2":::
      ...
      *   [Reaktionsschnelle Bilder][MDNResponsiveImages]  
      ...
      Verwendet [Geräteemulationstools][DevToolsGuideDeviceModeTestingOtherBrowsers] aus Ihrem Browser, um lokal zu testen oder eine Remotedebugsitzung auf [Windows][DevtoolsRemoteDebuggingWindows] oder [Android][DevtoolsRemoteDebuggingIndex] zu erstellen, um direkt auf einem Zielgerät zu testen.
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="1":::
...
:::row:::
   ...
   :::column-end:::
   :::column span="2":::
      Überprüft Ihre PWA anhand der Google-PWA Prüfliste.  
   :::column-end:::
:::row-end:::  

> [!NOTE]
> Um Ihre PWA in eine [Microsoft Store][MicrosoftDeveloperStore] zu verwandeln, navigieren Sie zu [Progressive Web Apps im Microsoft Store][PwaChromiumMicrosoftStore].  
