...
---
# <a name="getting-started-with-webview2-in-windows-forms"></a>Erste Schritte mit WebView2 in Windows Formularen
...
*   [WebView2 Runtime][MicrosoftDeveloperMicrosoftEdgeWebview2] oder Microsoft Edge [(Chromium)][MicrosoftedgeinsiderDownload] nicht stabile Kanal, der auf dem unterstützten Betriebssystem \(derzeit Windows 10, Windows 8.1 und Windows 7\ installiert ist).  
...
1.  Wählen Visual Studio Wählen Sie **Windows Forms .NET Framework App**Next  >  **aus.**
    
    :::image type="complex" source="./media/winforms-newproject.png" alt-text="Neues Projekt" lightbox="./media/winforms-newproject.png":::
       Neues Projekt  
    :::image-end:::
    
1.  Geben Sie Werte für **Project und** **Location ein.**  Wählen **.NET Framework 4.6.2** oder höher aus.  
...
1.  Suchen Sie in der **Toolbox**nach **WebView2.**  
    ...
    Ziehen Und ablegen Sie das **WebView2-Steuerelement** in die Windows Forms App.
...
> [!NOTE]
> Wenn Sie an einem Monitor mit hohem DPI arbeiten, müssen Sie möglicherweise Ihre [Windows Forms-App][DotnetFrameworkWinformsHighDpiSupportWindowsFormsConfiguringYourWindowsFormsAppForHighDpiSupport]für die Unterstützung mit hohem DPI konfigurieren.  

## <a name="step-4---handle-window-resize-events"></a>Schritt 4 – Behandeln von Ereignissen für die Fenstergröße  

Fügen Sie ihrer Windows aus der Toolbox ein paar weitere Steuerelemente hinzu, und behandeln Sie die Ereignisse für die Fenstergröße entsprechend.  

1.  Öffnen Sie **im Windows Forms Designer**die **Toolbox**.  
1.  Ziehen sie ein **TextBox-Objekt** in die Windows Forms App.  Benennen Sie **das TextBox-Postfach** `addressBar` auf der Registerkarte **Eigenschaften**.  
