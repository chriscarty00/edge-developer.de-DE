...
[get_AreRemoteObjectsAllowed](#get_areremoteobjectsallowed) | Die AreRemoteObjectsAllowed-Eigenschaft wird verwendet, um zu steuern, ob auf Remoteobjekten über die Seite in WebView zugegriffen werden kann.
...
Ist standardmäßig auf true festgelegt. Wenn diese Option deaktiviert ist, kann der Benutzer nicht mit STRG +/-oder STRG + Mausrad zoomen, aber der Zoom kann über put_ZoomFactor-API eingestellt werden.
