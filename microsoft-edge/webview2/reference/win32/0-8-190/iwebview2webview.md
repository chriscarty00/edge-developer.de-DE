...
[<span data-ttu-id="f9d11-117">MoveFocus</span><span class="sxs-lookup"><span data-stu-id="f9d11-117">MoveFocus</span></span>](#movefocus) | <span data-ttu-id="f9d11-118">Verschieben des Fokus in WebView</span><span class="sxs-lookup"><span data-stu-id="f9d11-118">Move focus into WebView.</span></span>
...
[<span data-ttu-id="f9d11-143">remove_GotFocus</span><span class="sxs-lookup"><span data-stu-id="f9d11-143">remove_GotFocus</span></span>](#remove_gotfocus) | <span data-ttu-id="f9d11-144">Entfernen Sie einen Ereignishandler, der zuvor mit add_GotFocus hinzugefügt wurde.</span><span class="sxs-lookup"><span data-stu-id="f9d11-144">Remove an event handler previously added with add_GotFocus.</span></span>
...
[<span data-ttu-id="f9d11-195">add_WebMessageReceived</span><span class="sxs-lookup"><span data-stu-id="f9d11-195">add_WebMessageReceived</span></span>](#add_webmessagereceived) | <span data-ttu-id="f9d11-196">Dieses Ereignis wird ausgelöst, wenn die IsWebMessageEnabled-Einstellung festgelegt ist, und das Dokument auf oberster Ebene des WebView-Anrufs `window.chrome.webview.postMessage` .</span><span class="sxs-lookup"><span data-stu-id="f9d11-196">This event fires when the IsWebMessageEnabled setting is set and the top level document of the webview calls `window.chrome.webview.postMessage`.</span></span>
...
<span data-ttu-id="f9d11-309">Verschieben des Fokus in WebView</span><span class="sxs-lookup"><span data-stu-id="f9d11-309">Move focus into WebView.</span></span>
...
#### <span data-ttu-id="f9d11-320">NavigateToString</span><span class="sxs-lookup"><span data-stu-id="f9d11-320">NavigateToString</span></span> 
...
#### <span data-ttu-id="f9d11-348">add_FrameNavigationStarting</span><span class="sxs-lookup"><span data-stu-id="f9d11-348">add_FrameNavigationStarting</span></span> 
...
#### <span data-ttu-id="f9d11-356">add_MoveFocusRequested</span><span class="sxs-lookup"><span data-stu-id="f9d11-356">add_MoveFocusRequested</span></span> 
...
<span data-ttu-id="f9d11-362">Entfernen Sie einen Ereignishandler, der zuvor mit add_MoveFocusRequested hinzugefügt wurde.</span><span class="sxs-lookup"><span data-stu-id="f9d11-362">Remove an event handler previously added with add_MoveFocusRequested.</span></span>
...
#### <span data-ttu-id="f9d11-377">remove_LostFocus</span><span class="sxs-lookup"><span data-stu-id="f9d11-377">remove_LostFocus</span></span> 
...
<span data-ttu-id="f9d11-394">Fügen Sie einen Ereignishandler für das ScriptDialogOpening-Ereignis hinzu.</span><span class="sxs-lookup"><span data-stu-id="f9d11-394">Add an event handler for the ScriptDialogOpening event.</span></span>
...
<span data-ttu-id="f9d11-404">Das Ereignis wird ausgelöst, wenn die ZoomFactor-Eigenschaft des WebView geändert wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-404">The event fires when the ZoomFactor property of the WebView changes.</span></span> <span data-ttu-id="f9d11-405">Das Ereignis konnte ausgelöst werden, weil der Aufrufer die ZoomFactor-Eigenschaft geändert hat, oder weil der Benutzer den Zoom manuell geändert hat.</span><span class="sxs-lookup"><span data-stu-id="f9d11-405">The event could fire because the caller modified the ZoomFactor property, or due to the user manually modifying the zoom.</span></span> <span data-ttu-id="f9d11-406">Wenn Sie vom Aufrufer über die ZoomFactor-Eigenschaft geändert wird, wird der interne Zoomfaktor sofort aktualisiert, und es gibt kein ZoomFactorChanged-Ereignis.</span><span class="sxs-lookup"><span data-stu-id="f9d11-406">When it is modified by the caller via the ZoomFactor property, the internal zoom factor is updated immediately and there will be no ZoomFactorChanged event.</span></span> <span data-ttu-id="f9d11-407">WebView ordnet den zuletzt verwendeten Zoomfaktor für jede Website zu.</span><span class="sxs-lookup"><span data-stu-id="f9d11-407">WebView associates the last used zoom factor for each site.</span></span> <span data-ttu-id="f9d11-408">Daher ist es möglich, dass sich der Zoomfaktor ändert, wenn Sie zu einer anderen Seite navigieren.</span><span class="sxs-lookup"><span data-stu-id="f9d11-408">Therefore, it is possible for the zoom factor to change when navigating to a different page.</span></span> <span data-ttu-id="f9d11-409">Wenn sich der Zoomfaktor aufgrund dieser Änderung ändert, wird das ZoomFactorChanged-Ereignis direkt hinter dem DocumentStateChanged-Ereignis ausgelöst.</span><span class="sxs-lookup"><span data-stu-id="f9d11-409">When the zoom factor changes due to this, the ZoomFactorChanged event fires right after the DocumentStateChanged event.</span></span>
...
#### <span data-ttu-id="f9d11-410">remove_ZoomFactorChanged</span><span class="sxs-lookup"><span data-stu-id="f9d11-410">remove_ZoomFactorChanged</span></span> 

<span data-ttu-id="f9d11-411">Entfernen Sie einen Ereignishandler, der zuvor mit add_ZoomFactorChanged hinzugefügt wurde.</span><span class="sxs-lookup"><span data-stu-id="f9d11-411">Remove an event handler previously added with add_ZoomFactorChanged.</span></span>

> <span data-ttu-id="f9d11-412">Public HRESULT [remove_ZoomFactorChanged](#remove_zoomfactorchanged)(EventRegistrationToken-Token)</span><span class="sxs-lookup"><span data-stu-id="f9d11-412">public HRESULT [remove_ZoomFactorChanged](#remove_zoomfactorchanged)(EventRegistrationToken token)</span></span>

#### <span data-ttu-id="f9d11-413">add_PermissionRequested</span><span class="sxs-lookup"><span data-stu-id="f9d11-413">add_PermissionRequested</span></span> 

<span data-ttu-id="f9d11-414">Fügen Sie einen Ereignishandler für das PermissionRequested-Ereignis hinzu.</span><span class="sxs-lookup"><span data-stu-id="f9d11-414">Add an event handler for the PermissionRequested event.</span></span>

> <span data-ttu-id="f9d11-415">Public HRESULT [add_PermissionRequested](#add_permissionrequested)([IWebView2PermissionRequestedEventHandler](IWebView2PermissionRequestedEventHandler.md) \* EventHandler, EventRegistrationToken \* Token)</span><span class="sxs-lookup"><span data-stu-id="f9d11-415">public HRESULT [add_PermissionRequested](#add_permissionrequested)([IWebView2PermissionRequestedEventHandler](IWebView2PermissionRequestedEventHandler.md) \* eventHandler,EventRegistrationToken \* token)</span></span>

<span data-ttu-id="f9d11-416">Wird ausgelöst, wenn Inhalt in einer WebView-Anforderung die Berechtigung für den Zugriff auf einige Privilegierte Ressourcen anfordert.</span><span class="sxs-lookup"><span data-stu-id="f9d11-416">Fires when content in a WebView requests permission to access some privileged resources.</span></span>
...
#### <span data-ttu-id="f9d11-417">remove_PermissionRequested</span><span class="sxs-lookup"><span data-stu-id="f9d11-417">remove_PermissionRequested</span></span> 

<span data-ttu-id="f9d11-418">Entfernen Sie einen Ereignishandler, der zuvor mit add_PermissionRequested hinzugefügt wurde.</span><span class="sxs-lookup"><span data-stu-id="f9d11-418">Remove an event handler previously added with add_PermissionRequested.</span></span>

> <span data-ttu-id="f9d11-419">Public HRESULT [remove_PermissionRequested](#remove_permissionrequested)(EventRegistrationToken-Token)</span><span class="sxs-lookup"><span data-stu-id="f9d11-419">public HRESULT [remove_PermissionRequested](#remove_permissionrequested)(EventRegistrationToken token)</span></span>

#### <span data-ttu-id="f9d11-420">add_ProcessFailed</span><span class="sxs-lookup"><span data-stu-id="f9d11-420">add_ProcessFailed</span></span> 

<span data-ttu-id="f9d11-421">Fügen Sie einen Ereignishandler für das ProcessFailed-Ereignis hinzu.</span><span class="sxs-lookup"><span data-stu-id="f9d11-421">Add an event handler for the ProcessFailed event.</span></span>

> <span data-ttu-id="f9d11-422">Public HRESULT [add_ProcessFailed](#add_processfailed)([IWebView2ProcessFailedEventHandler](IWebView2ProcessFailedEventHandler.md) \* EventHandler, EventRegistrationToken \* Token)</span><span class="sxs-lookup"><span data-stu-id="f9d11-422">public HRESULT [add_ProcessFailed](#add_processfailed)([IWebView2ProcessFailedEventHandler](IWebView2ProcessFailedEventHandler.md) \* eventHandler,EventRegistrationToken \* token)</span></span>

<span data-ttu-id="f9d11-423">Wird ausgelöst, wenn ein WebView-Prozess unerwartet beendet wird oder nicht mehr reagiert.</span><span class="sxs-lookup"><span data-stu-id="f9d11-423">Fires when a WebView process terminated unexpectedly or become unresponsive.</span></span>
...
#### <span data-ttu-id="f9d11-424">remove_ProcessFailed</span><span class="sxs-lookup"><span data-stu-id="f9d11-424">remove_ProcessFailed</span></span> 

<span data-ttu-id="f9d11-425">Entfernen Sie einen Ereignishandler, der zuvor mit add_ProcessFailed hinzugefügt wurde.</span><span class="sxs-lookup"><span data-stu-id="f9d11-425">Remove an event handler previously added with add_ProcessFailed.</span></span>

> <span data-ttu-id="f9d11-426">Public HRESULT [remove_ProcessFailed](#remove_processfailed)(EventRegistrationToken-Token)</span><span class="sxs-lookup"><span data-stu-id="f9d11-426">public HRESULT [remove_ProcessFailed](#remove_processfailed)(EventRegistrationToken token)</span></span>

#### <span data-ttu-id="f9d11-427">AddScriptToExecuteOnDocumentCreated</span><span class="sxs-lookup"><span data-stu-id="f9d11-427">AddScriptToExecuteOnDocumentCreated</span></span> 

<span data-ttu-id="f9d11-428">Fügen Sie das bereitgestellte JavaScript einer Liste von Skripts hinzu, die ausgeführt werden sollen, nachdem das globale Objekt erstellt wurde, aber bevor das HTML-Dokument analysiert wurde und bevor ein anderes Skript ausgeführt wird, das vom HTML-Dokument eingeschlossen ist.</span><span class="sxs-lookup"><span data-stu-id="f9d11-428">Add the provided JavaScript to a list of scripts that should be executed after the global object has been created, but before the HTML document has been parsed and before any other script included by the HTML document is executed.</span></span>

> <span data-ttu-id="f9d11-429">Public HRESULT [AddScriptToExecuteOnDocumentCreated](#addscripttoexecuteondocumentcreated)(LPCWSTR javaScript,[IWebView2AddScriptToExecuteOnDocumentCreatedCompletedHandler](IWebView2AddScriptToExecuteOnDocumentCreatedCompletedHandler.md) \* Handler)</span><span class="sxs-lookup"><span data-stu-id="f9d11-429">public HRESULT [AddScriptToExecuteOnDocumentCreated](#addscripttoexecuteondocumentcreated)(LPCWSTR javaScript,[IWebView2AddScriptToExecuteOnDocumentCreatedCompletedHandler](IWebView2AddScriptToExecuteOnDocumentCreatedCompletedHandler.md) \* handler)</span></span>

<span data-ttu-id="f9d11-430">Das eingefügte Skript gilt für alle zukünftigen Dokumente und untergeordneten Frame-Navigationselemente auf oberster Ebene, bis Sie mit RemoveScriptToExecuteOnDocumentCreated entfernt werden.</span><span class="sxs-lookup"><span data-stu-id="f9d11-430">The injected script will apply to all future top level document and child frame navigations until removed with RemoveScriptToExecuteOnDocumentCreated.</span></span> <span data-ttu-id="f9d11-431">Diese wird asynchron angewendet, und Sie müssen warten, bis der vervollständigungshandler ausgeführt wird, bevor Sie sicher sein können, dass das Skript für zukünftige Navigationen ausgeführt werden kann.</span><span class="sxs-lookup"><span data-stu-id="f9d11-431">This is applied asynchronously and you must wait for the completion handler to run before you can be sure that the script is ready to execute on future navigations.</span></span>

<span data-ttu-id="f9d11-432">Beachten Sie, dass sich dies auf das hier ausgeführte Skript auswirkt, wenn ein HTML-Dokument über Sandbox [-Eigenschaften oder über den](https://developer.mozilla.org/docs/Web/HTML/Element/iframe#attr-sandbox) [Content-Security-Policy-HTTP-Header](https://developer.mozilla.org/docs/Web/HTTP/Headers/Content-Security-Policy) eine Art Sandbox hat.</span><span class="sxs-lookup"><span data-stu-id="f9d11-432">Note that if an HTML document has sandboxing of some kind via [sandbox](https://developer.mozilla.org/docs/Web/HTML/Element/iframe#attr-sandbox) properties or the [Content-Security-Policy HTTP header](https://developer.mozilla.org/docs/Web/HTTP/Headers/Content-Security-Policy) this will affect the script run here.</span></span> <span data-ttu-id="f9d11-433">Wenn also beispielsweise das Schlüsselwort "Allow-modals" nicht festgesetzt ist, werden Aufrufe der `alert` Funktion ignoriert.</span><span class="sxs-lookup"><span data-stu-id="f9d11-433">So, for example, if the 'allow-modals' keyword is not set then calls to the `alert` function will be ignored.</span></span>
...
#### <span data-ttu-id="f9d11-434">RemoveScriptToExecuteOnDocumentCreated</span><span class="sxs-lookup"><span data-stu-id="f9d11-434">RemoveScriptToExecuteOnDocumentCreated</span></span> 

<span data-ttu-id="f9d11-435">Entfernen Sie das entsprechende JavaScript, das über AddScriptToExecuteOnDocumentCreated hinzugefügt wurde.</span><span class="sxs-lookup"><span data-stu-id="f9d11-435">Remove the corresponding JavaScript added via AddScriptToExecuteOnDocumentCreated.</span></span>

> <span data-ttu-id="f9d11-436">Public HRESULT [RemoveScriptToExecuteOnDocumentCreated](#removescripttoexecuteondocumentcreated)(LPCWSTR-ID)</span><span class="sxs-lookup"><span data-stu-id="f9d11-436">public HRESULT [RemoveScriptToExecuteOnDocumentCreated](#removescripttoexecuteondocumentcreated)(LPCWSTR id)</span></span>

#### <span data-ttu-id="f9d11-437">ExecuteScript</span><span class="sxs-lookup"><span data-stu-id="f9d11-437">ExecuteScript</span></span> 

<span data-ttu-id="f9d11-438">Führen Sie JavaScript-Code aus dem JavaScript-Parameter im aktuellen Dokument der obersten Ebene aus, das in der WebView gerendert wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-438">Execute JavaScript code from the javascript parameter in the current top level document rendered in the WebView.</span></span>

> <span data-ttu-id="f9d11-439">Public HRESULT [executeScript](#executescript)(LPCWSTR javaScript,[IWebView2ExecuteScriptCompletedHandler](IWebView2ExecuteScriptCompletedHandler.md) \* Handler)</span><span class="sxs-lookup"><span data-stu-id="f9d11-439">public HRESULT [ExecuteScript](#executescript)(LPCWSTR javaScript,[IWebView2ExecuteScriptCompletedHandler](IWebView2ExecuteScriptCompletedHandler.md) \* handler)</span></span>

<span data-ttu-id="f9d11-440">Dies wird asynchron ausgeführt, und wenn ein Handler im ExecuteScriptCompletedHandler-Parameter bereitgestellt wird, wird die Invoke-Methode mit dem Ergebnis der Auswertung des bereitgestellten JavaScript aufgerufen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-440">This will execute asynchronously and when complete, if a handler is provided in the ExecuteScriptCompletedHandler parameter, its Invoke method will be called with the result of evaluating the provided JavaScript.</span></span> <span data-ttu-id="f9d11-441">Der Ergebniswert ist eine JSON-codierte Zeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="f9d11-441">The result value is a JSON encoded string.</span></span> <span data-ttu-id="f9d11-442">Wenn das Ergebnis undefiniert ist, einen Referenz Zyklus enthält oder in JSON nicht codiert werden kann, wird der JSON-NULL-Wert als Zeichenfolge "Null" zurückgegeben.</span><span class="sxs-lookup"><span data-stu-id="f9d11-442">If the result is undefined, contains a reference cycle, or otherwise cannot be encoded into JSON, the JSON null value will be returned as the string 'null'.</span></span> <span data-ttu-id="f9d11-443">Beachten Sie, dass eine Funktion, die keinen expliziten Rückgabewert aufweist, undefined zurückgibt.</span><span class="sxs-lookup"><span data-stu-id="f9d11-443">Note that a function that has no explicit return value returns undefined.</span></span> <span data-ttu-id="f9d11-444">Wenn das ausgeführte Skript eine nicht behandelte Ausnahme auslöst, ist das Ergebnis auch "Null".</span><span class="sxs-lookup"><span data-stu-id="f9d11-444">If the executed script throws an unhandled exception, then the result is also 'null'.</span></span> <span data-ttu-id="f9d11-445">Diese Methode wird asynchron angewendet.</span><span class="sxs-lookup"><span data-stu-id="f9d11-445">This method is applied asynchronously.</span></span> <span data-ttu-id="f9d11-446">Wenn der Aufruf erfolgt, während sich die WebView in einem Dokument befindet und eine Navigation nach dem Aufruf erfolgt, aber bevor das JavaScript ausgeführt wird, wird das Skript nicht ausgeführt, und der Handler wird mit E_FAIL für seinen errorCode-Parameter aufgerufen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-446">If the call is made while the webview is on one document, and a navigation occurs after the call is made but before the JavaScript is executed, then the script will not be executed and the handler will be called with E_FAIL for its errorCode parameter.</span></span> <span data-ttu-id="f9d11-447">ExecuteScript funktioniert auch dann, wenn IsScriptEnabled auf "false" festgelegt ist.</span><span class="sxs-lookup"><span data-stu-id="f9d11-447">ExecuteScript will work even if IsScriptEnabled is set to FALSE.</span></span>
...
#### <span data-ttu-id="f9d11-448">CapturePreview</span><span class="sxs-lookup"><span data-stu-id="f9d11-448">CapturePreview</span></span> 

<span data-ttu-id="f9d11-449">Erfassen Sie ein Bild von der Anzeige von WebView.</span><span class="sxs-lookup"><span data-stu-id="f9d11-449">Capture an image of what WebView is displaying.</span></span>

> <span data-ttu-id="f9d11-450">Public HRESULT [CapturePreview](#capturepreview)([WEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT](#webview2_capture_preview_image_format) Image Format, IStream \* ImageStream,[IWebView2CapturePreviewCompletedHandler](IWebView2CapturePreviewCompletedHandler.md) \*-Handler)</span><span class="sxs-lookup"><span data-stu-id="f9d11-450">public HRESULT [CapturePreview](#capturepreview)([WEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT](#webview2_capture_preview_image_format) imageFormat,IStream \* imageStream,[IWebView2CapturePreviewCompletedHandler](IWebView2CapturePreviewCompletedHandler.md) \* handler)</span></span>

<span data-ttu-id="f9d11-451">Geben Sie das Format des Bilds mit dem ImageFormat-Parameter an.</span><span class="sxs-lookup"><span data-stu-id="f9d11-451">Specify the format of the image with the imageFormat parameter.</span></span> <span data-ttu-id="f9d11-452">Die resultierenden Bild Binärdaten werden in den bereitgestellten ImageStream-Parameter geschrieben.</span><span class="sxs-lookup"><span data-stu-id="f9d11-452">The resulting image binary data is written to the provided imageStream parameter.</span></span> <span data-ttu-id="f9d11-453">Wenn CapturePreview den Schreibvorgang in den Datenstrom abgeschlossen hat, wird die Invoke-Methode für den bereitgestellten Handler-Parameter aufgerufen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-453">When CapturePreview finishes writing to the stream, the Invoke method on the provided handler parameter is called.</span></span>
...
#### <span data-ttu-id="f9d11-454">Laden</span><span class="sxs-lookup"><span data-stu-id="f9d11-454">Reload</span></span> 

<span data-ttu-id="f9d11-455">Laden Sie die aktuelle Seite neu.</span><span class="sxs-lookup"><span data-stu-id="f9d11-455">Reload the current page.</span></span>

> <span data-ttu-id="f9d11-456">Public HRESULT [Reload](#reload)()</span><span class="sxs-lookup"><span data-stu-id="f9d11-456">public HRESULT [Reload](#reload)()</span></span>

<span data-ttu-id="f9d11-457">Dies ähnelt der Navigation zum URI des aktuellen Dokuments auf oberster Ebene, einschließlich aller Navigationsereignisse, die alle Einträge im HTTP-Cache auslösen und respektieren.</span><span class="sxs-lookup"><span data-stu-id="f9d11-457">This is similar to navigating to the URI of current top level document including all navigation events firing and respecting any entries in the HTTP cache.</span></span> <span data-ttu-id="f9d11-458">Das zurück/weiter-Protokoll wird jedoch nicht geändert.</span><span class="sxs-lookup"><span data-stu-id="f9d11-458">But, the back/forward history will not be modified.</span></span>

#### <span data-ttu-id="f9d11-459">get_Bounds</span><span class="sxs-lookup"><span data-stu-id="f9d11-459">get_Bounds</span></span> 

<span data-ttu-id="f9d11-460">Die WebView-Begrenzungen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-460">The webview bounds.</span></span>

> <span data-ttu-id="f9d11-461">öffentliche HRESULT- [get_Bounds](#get_bounds)(Rect \* bounds)</span><span class="sxs-lookup"><span data-stu-id="f9d11-461">public HRESULT [get_Bounds](#get_bounds)(RECT \* bounds)</span></span>

<span data-ttu-id="f9d11-462">Begrenzungen sind relativ zum übergeordneten HWND.</span><span class="sxs-lookup"><span data-stu-id="f9d11-462">Bounds are relative to the parent HWND.</span></span> <span data-ttu-id="f9d11-463">Die APP hat zwei Möglichkeiten, um eine WebView-Position zu positionieren:</span><span class="sxs-lookup"><span data-stu-id="f9d11-463">The app has two ways it can position a WebView:</span></span>

1. <span data-ttu-id="f9d11-464">Erstellen Sie ein untergeordnetes HWND, das das übergeordnete HWND von WebView ist.</span><span class="sxs-lookup"><span data-stu-id="f9d11-464">Create a child HWND that is the WebView parent HWND.</span></span> <span data-ttu-id="f9d11-465">Positionieren Sie dieses Fenster, in dem sich die WebView befinden soll.</span><span class="sxs-lookup"><span data-stu-id="f9d11-465">Position this window where the WebView should be.</span></span> <span data-ttu-id="f9d11-466">Verwenden Sie in diesem Fall (0, 0) für die Bound's obere linke Ecke des Webviews (den Offset).</span><span class="sxs-lookup"><span data-stu-id="f9d11-466">In this case, use (0, 0) for the WebView's Bound's top left corner (the offset).</span></span>

1. <span data-ttu-id="f9d11-467">Verwenden Sie das oberste Fenster der App als übergeordnetes WebView-HWND.</span><span class="sxs-lookup"><span data-stu-id="f9d11-467">Use the app's top most window as the WebView parent HWND.</span></span> <span data-ttu-id="f9d11-468">Stellen Sie die Bound's-obere linke Ecke der WebView so ein, dass die WebView in der APP richtig positioniert ist.</span><span class="sxs-lookup"><span data-stu-id="f9d11-468">Set the WebView's Bound's top left corner so that the WebView is positioned correctly in the app.</span></span> <span data-ttu-id="f9d11-469">Die Werte der Bounds befinden sich im Koordinatenbereich des Hosts.</span><span class="sxs-lookup"><span data-stu-id="f9d11-469">The Bound's values are in the host's coordinate space.</span></span>

#### <span data-ttu-id="f9d11-470">put_Bounds</span><span class="sxs-lookup"><span data-stu-id="f9d11-470">put_Bounds</span></span> 

<span data-ttu-id="f9d11-471">Die Bounds-Eigenschaft festlegen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-471">Set the Bounds property.</span></span>

> <span data-ttu-id="f9d11-472">öffentliche HRESULT- [put_Bounds](#put_bounds)(Rect-Begrenzungen)</span><span class="sxs-lookup"><span data-stu-id="f9d11-472">public HRESULT [put_Bounds](#put_bounds)(RECT bounds)</span></span>
...
#### <span data-ttu-id="f9d11-473">get_ZoomFactor</span><span class="sxs-lookup"><span data-stu-id="f9d11-473">get_ZoomFactor</span></span> 

<span data-ttu-id="f9d11-474">Der Zoomfaktor für die aktuelle Seite im WebView.</span><span class="sxs-lookup"><span data-stu-id="f9d11-474">The zoom factor for the current page in the WebView.</span></span>

> <span data-ttu-id="f9d11-475">öffentliche HRESULT- [get_ZoomFactor](#get_zoomfactor)(Double \* ZoomFactor)</span><span class="sxs-lookup"><span data-stu-id="f9d11-475">public HRESULT [get_ZoomFactor](#get_zoomfactor)(double \* zoomFactor)</span></span>

<span data-ttu-id="f9d11-476">Der Zoomfaktor wird pro Website beibehalten.</span><span class="sxs-lookup"><span data-stu-id="f9d11-476">The zoom factor is persisted per site.</span></span> <span data-ttu-id="f9d11-477">Beachten Sie, dass das Ändern des Zoomfaktors `window.innerWidth/innerHeight` zu einer Änderung des Seitenlayouts führen kann.</span><span class="sxs-lookup"><span data-stu-id="f9d11-477">Note that changing zoom factor could cause `window.innerWidth/innerHeight` and page layout to change.</span></span> <span data-ttu-id="f9d11-478">Wenn WebView von einer anderen Website zu einer Seite navigiert, wird der Zoomfaktor für die vorherige Seite nicht angewendet.</span><span class="sxs-lookup"><span data-stu-id="f9d11-478">When WebView navigates to a page from a different site, the zoom factor set for the previous page will not be applied.</span></span> <span data-ttu-id="f9d11-479">Wenn die APP den Zoomfaktor für eine bestimmte Seite einstellen möchte, befindet sich der früheste Ort im DocumentStateChanged-Ereignishandler.</span><span class="sxs-lookup"><span data-stu-id="f9d11-479">If the app wants to set the zoom factor for a certain page, the earliest place to do it is in the DocumentStateChanged event handler.</span></span> <span data-ttu-id="f9d11-480">Wenn dies der Fall ist, wird möglicherweise ein ZoomFactorChanged-Ereignis für den beibehaltenen Zoomfaktor empfangen, bevor das ZoomFactorChanged-Ereignis für den angegebenen Zoomfaktor empfangen wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-480">Note that if it does that, it might receive a ZoomFactorChanged event for the persisted zoom factor before receiving the ZoomFactorChanged event for the specified zoom factor.</span></span> <span data-ttu-id="f9d11-481">Die Angabe einer ZoomFactor kleiner oder gleich 0 ist nicht zulässig.</span><span class="sxs-lookup"><span data-stu-id="f9d11-481">Specifying a zoomFactor less than or equal to 0 is not allowed.</span></span> <span data-ttu-id="f9d11-482">WebView verfügt auch über einen internen unterstützten Zoomfaktor Bereich.</span><span class="sxs-lookup"><span data-stu-id="f9d11-482">WebView also has an internal supported zoom factor range.</span></span> <span data-ttu-id="f9d11-483">Wenn sich ein angegebener Zoomfaktor außerhalb dieses Bereichs befindet, wird er normalisiert, sodass er innerhalb des Bereichs liegt, und ein ZoomFactorChanged-Ereignis wird für den tatsächlich angewendeten Zoomfaktor ausgelöst.</span><span class="sxs-lookup"><span data-stu-id="f9d11-483">When a specified zoom factor is out of that range, it will be normalized to be within the range, and a ZoomFactorChanged event will be fired for the real applied zoom factor.</span></span> <span data-ttu-id="f9d11-484">Wenn diese Bereichs Normalisierung erfolgt, meldet die ZoomFactor-Eigenschaft den Zoomfaktor, der während der vorherigen Änderung der ZoomFactor-Eigenschaft angegeben wird, bis das ZoomFactorChanged-Ereignis empfangen wird, nachdem WebView den normalisierten Zoomfaktor angewendet hat.</span><span class="sxs-lookup"><span data-stu-id="f9d11-484">When this range normalization happens, the ZoomFactor property will report the zoom factor specified during the previous modification of the ZoomFactor property until the ZoomFactorChanged event is received after webview applies the normalized zoom factor.</span></span>

#### <span data-ttu-id="f9d11-485">put_ZoomFactor</span><span class="sxs-lookup"><span data-stu-id="f9d11-485">put_ZoomFactor</span></span> 

<span data-ttu-id="f9d11-486">Festlegen der ZoomFactor-Eigenschaft</span><span class="sxs-lookup"><span data-stu-id="f9d11-486">Set the ZoomFactor property.</span></span>

> <span data-ttu-id="f9d11-487">öffentliche HRESULT- [put_ZoomFactor](#put_zoomfactor)(Double ZoomFactor)</span><span class="sxs-lookup"><span data-stu-id="f9d11-487">public HRESULT [put_ZoomFactor](#put_zoomfactor)(double zoomFactor)</span></span>

#### <span data-ttu-id="f9d11-488">get_IsVisible</span><span class="sxs-lookup"><span data-stu-id="f9d11-488">get_IsVisible</span></span> 

<span data-ttu-id="f9d11-489">Die IsVisible-Eigenschaft bestimmt, ob die WebView angezeigt oder ausgeblendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="f9d11-489">The IsVisible property determines whether to show or hide the webview.</span></span>

> <span data-ttu-id="f9d11-490">öffentliche HRESULT- [get_IsVisible](#get_isvisible)(bool \* isVisible)</span><span class="sxs-lookup"><span data-stu-id="f9d11-490">public HRESULT [get_IsVisible](#get_isvisible)(BOOL \* isVisible)</span></span>

<span data-ttu-id="f9d11-491">Wenn IsVisible auf "false" festgelegt ist, ist die WebView transparent und wird nicht gerendert.</span><span class="sxs-lookup"><span data-stu-id="f9d11-491">If IsVisible is set to false, the webview will be transparent and will not be rendered.</span></span> <span data-ttu-id="f9d11-492">Dies wirkt sich jedoch nicht auf das Fenster aus, das die WebView enthält (den HWND-Parameter, der an CreateView übergeben wurde).</span><span class="sxs-lookup"><span data-stu-id="f9d11-492">However, this will not affect the window containing the webview (the HWND parameter that was passed to CreateWebView).</span></span> <span data-ttu-id="f9d11-493">Wenn Sie möchten, dass das Fenster ebenfalls ausgeblendet wird, rufen Sie ShowWindow direkt zusätzlich zum Ändern der IsVisible-Eigenschaft auf.</span><span class="sxs-lookup"><span data-stu-id="f9d11-493">If you want that window to disappear too, call ShowWindow on it directly in addition to modifying the IsVisible property.</span></span> <span data-ttu-id="f9d11-494">WebView als untergeordnetes Fenster ruft keine Fenster Meldungen ab, wenn das oberste Fenster minimiert oder wiederhergestellt wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-494">WebView as a child window won't get window messages when the top window is minimized or restored.</span></span> <span data-ttu-id="f9d11-495">Aus Leistungsgründen sollte Entwickler die IsVisible-Eigenschaft der WebView-Eigenschaft auf "false" festlegen, wenn das App-Fenster minimiert wird, und zurück zu "true", wenn das App-Fenster wiederhergestellt wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-495">For performance reason, developer should set IsVisible property of the WebView to false when the app window is minimized and back to true when app window is restored.</span></span> <span data-ttu-id="f9d11-496">Das App-Fenster kann dies tun, indem SC_MINIMIZE und SC_RESTORE Befehl beim empfangen WM_SYSCOMMAND Nachricht behandelt werden.</span><span class="sxs-lookup"><span data-stu-id="f9d11-496">App window can do this by handling SC_MINIMIZE and SC_RESTORE command upon receiving WM_SYSCOMMAND message.</span></span>
...
#### <span data-ttu-id="f9d11-497">put_IsVisible</span><span class="sxs-lookup"><span data-stu-id="f9d11-497">put_IsVisible</span></span> 

<span data-ttu-id="f9d11-498">Festlegen der IsVisible-Eigenschaft</span><span class="sxs-lookup"><span data-stu-id="f9d11-498">Set the IsVisible property.</span></span>

> <span data-ttu-id="f9d11-499">öffentliche HRESULT- [put_IsVisible](#put_isvisible)(bool isVisible)</span><span class="sxs-lookup"><span data-stu-id="f9d11-499">public HRESULT [put_IsVisible](#put_isvisible)(BOOL isVisible)</span></span>
...
#### <span data-ttu-id="f9d11-500">PostWebMessageAsJson</span><span class="sxs-lookup"><span data-stu-id="f9d11-500">PostWebMessageAsJson</span></span> 

<span data-ttu-id="f9d11-501">Posten Sie die angegebene Webnachricht im Dokument der obersten Ebene in diesem [IWebView2WebView]().</span><span class="sxs-lookup"><span data-stu-id="f9d11-501">Post the specified webMessage to the top level document in this [IWebView2WebView]().</span></span>

> <span data-ttu-id="f9d11-502">Public HRESULT [PostWebMessageAsJson](#postwebmessageasjson)(LPCWSTR webMessageAsJson)</span><span class="sxs-lookup"><span data-stu-id="f9d11-502">public HRESULT [PostWebMessageAsJson](#postwebmessageasjson)(LPCWSTR webMessageAsJson)</span></span>

<span data-ttu-id="f9d11-503">Das Nachrichtenereignis des Fensters "Window. Chrome. WebView" des obersten Dokuments wird ausgelöst.</span><span class="sxs-lookup"><span data-stu-id="f9d11-503">The top level document's window.chrome.webview's message event fires.</span></span> <span data-ttu-id="f9d11-504">JavaScript in diesem Dokument kann das Ereignis über Folgendes abonnieren und kündigen:</span><span class="sxs-lookup"><span data-stu-id="f9d11-504">JavaScript in that document may subscribe and unsubscribe to the event via the following:</span></span> 
...
```
 ...
 <span data-ttu-id="f9d11-505">Das Ereignis args ist eine Instanz von `MessageEvent` .</span><span class="sxs-lookup"><span data-stu-id="f9d11-505">The event args is an instance of `MessageEvent`.</span></span> <span data-ttu-id="f9d11-506">Die IWebView2Settings:: IsWebMessageEnabled-Einstellung muss wahr sein, oder diese Methode schlägt mit E_INVALIDARG fehl.</span><span class="sxs-lookup"><span data-stu-id="f9d11-506">The IWebView2Settings::IsWebMessageEnabled setting must be true or this method will fail with E_INVALIDARG.</span></span> <span data-ttu-id="f9d11-507">Die Dateneigenschaft des Ereignisses arg ist der webmessage-Zeichenfolgenparameter, der als JSON-Zeichenfolge in ein JavaScript-Objekt analysiert wurde.</span><span class="sxs-lookup"><span data-stu-id="f9d11-507">The event arg's data property is the webMessage string parameter parsed as a JSON string into a JavaScript object.</span></span> <span data-ttu-id="f9d11-508">Die Source-Eigenschaft des Ereignisses arg ist ein Verweis auf das `window.chrome.webview` Objekt.</span><span class="sxs-lookup"><span data-stu-id="f9d11-508">The event arg's source property is a reference to the `window.chrome.webview` object.</span></span> <span data-ttu-id="f9d11-509">Informationen zum Senden von Nachrichten aus dem HTML-Dokument in der WebView an den Host finden Sie unter SetWebMessageReceivedEventHandler.</span><span class="sxs-lookup"><span data-stu-id="f9d11-509">See SetWebMessageReceivedEventHandler for information on sending messages from the HTML document in the webview to the host.</span></span> <span data-ttu-id="f9d11-510">Diese Nachricht wird asynchron gesendet.</span><span class="sxs-lookup"><span data-stu-id="f9d11-510">This message is sent asynchronously.</span></span> <span data-ttu-id="f9d11-511">Wenn eine Navigation erfolgt, bevor die Nachricht auf der Seite veröffentlicht wird, wird die Nachricht nicht gesendet.</span><span class="sxs-lookup"><span data-stu-id="f9d11-511">If a navigation occurs before the message is posted to the page, then the message will not be sent.</span></span>
...
#### <span data-ttu-id="f9d11-512">PostWebMessageAsString</span><span class="sxs-lookup"><span data-stu-id="f9d11-512">PostWebMessageAsString</span></span> 

<span data-ttu-id="f9d11-513">Dies ist ein Helfer zum Posten einer Nachricht, bei der es sich um eine einfache Zeichenfolge und nicht um eine JSON-Zeichenfolgendarstellung eines JavaScript-Objekts handelt.</span><span class="sxs-lookup"><span data-stu-id="f9d11-513">This is a helper for posting a message that is a simple string rather than a JSON string representation of a JavaScript object.</span></span>

> <span data-ttu-id="f9d11-514">Public HRESULT [PostWebMessageAsString](#postwebmessageasstring)(LPCWSTR webMessageAsString)</span><span class="sxs-lookup"><span data-stu-id="f9d11-514">public HRESULT [PostWebMessageAsString](#postwebmessageasstring)(LPCWSTR webMessageAsString)</span></span>

<span data-ttu-id="f9d11-515">Dies verhält sich auf die gleiche Weise wie PostWebMessageAsJson, aber die `window.chrome.webview` Dateneigenschaft des Nachrichtenereignisses arg ist eine Zeichenfolge mit dem gleichen Wert wie webMessageAsString.</span><span class="sxs-lookup"><span data-stu-id="f9d11-515">This behaves in exactly the same manner as PostWebMessageAsJson but the `window.chrome.webview` message event arg's data property will be a string with the same value as webMessageAsString.</span></span> <span data-ttu-id="f9d11-516">Verwenden Sie diese anstelle von PostWebMessageAsJson, wenn Sie über einfache Zeichenfolgen anstelle von JSON-Objekten kommunizieren möchten.</span><span class="sxs-lookup"><span data-stu-id="f9d11-516">Use this instead of PostWebMessageAsJson if you want to communicate via simple strings rather than JSON objects.</span></span>

#### <span data-ttu-id="f9d11-517">add_WebMessageReceived</span><span class="sxs-lookup"><span data-stu-id="f9d11-517">add_WebMessageReceived</span></span> 

<span data-ttu-id="f9d11-518">Dieses Ereignis wird ausgelöst, wenn die IsWebMessageEnabled-Einstellung festgelegt ist, und das Dokument auf oberster Ebene des WebView-Anrufs `window.chrome.webview.postMessage` .</span><span class="sxs-lookup"><span data-stu-id="f9d11-518">This event fires when the IsWebMessageEnabled setting is set and the top level document of the webview calls `window.chrome.webview.postMessage`.</span></span>

> <span data-ttu-id="f9d11-519">öffentliche HRESULT- [add_WebMessageReceived](#add_webmessagereceived)([IWebView2WebMessageReceivedEventHandler](IWebView2WebMessageReceivedEventHandler.md) \*-Handler, EventRegistrationToken \*-Token)</span><span class="sxs-lookup"><span data-stu-id="f9d11-519">public HRESULT [add_WebMessageReceived](#add_webmessagereceived)([IWebView2WebMessageReceivedEventHandler](IWebView2WebMessageReceivedEventHandler.md) \* handler,EventRegistrationToken \* token)</span></span>

<span data-ttu-id="f9d11-520">Bei der Funktion PostMessage handelt es sich um `void postMessage(object)` ein Objekt, das von der JSON-Konvertierung unterstützt wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-520">The postMessage function is `void postMessage(object)` where object is any object supported by JSON conversion.</span></span>
...
#### <span data-ttu-id="f9d11-522">remove_WebMessageReceived</span><span class="sxs-lookup"><span data-stu-id="f9d11-522">remove_WebMessageReceived</span></span> 

<span data-ttu-id="f9d11-523">Entfernen Sie einen Ereignishandler, der zuvor mit add_WebMessageReceived hinzugefügt wurde.</span><span class="sxs-lookup"><span data-stu-id="f9d11-523">Remove an event handler previously added with add_WebMessageReceived.</span></span>

> <span data-ttu-id="f9d11-524">Public HRESULT [remove_WebMessageReceived](#remove_webmessagereceived)(EventRegistrationToken-Token)</span><span class="sxs-lookup"><span data-stu-id="f9d11-524">public HRESULT [remove_WebMessageReceived](#remove_webmessagereceived)(EventRegistrationToken token)</span></span>

#### <span data-ttu-id="f9d11-525">Schließen</span><span class="sxs-lookup"><span data-stu-id="f9d11-525">Close</span></span> 

<span data-ttu-id="f9d11-526">Schließt die WebView und bereinigt die zugrunde liegende Browserinstanz.</span><span class="sxs-lookup"><span data-stu-id="f9d11-526">Closes the webview and cleans up the underlying browser instance.</span></span>

> <span data-ttu-id="f9d11-527">Public HRESULT [Close](#close)()</span><span class="sxs-lookup"><span data-stu-id="f9d11-527">public HRESULT [Close](#close)()</span></span>

<span data-ttu-id="f9d11-528">Durch Bereinigen des Browsers Instanz werden die Ressourcen freigegeben, die die WebView-Ansicht einschalten.</span><span class="sxs-lookup"><span data-stu-id="f9d11-528">Cleaning up the browser instace will release the resources powering the webview.</span></span> <span data-ttu-id="f9d11-529">Die Browserinstanz wird heruntergefahren, wenn keine anderen Webansichten verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="f9d11-529">The browser instance will be shut down if there are no other webviews using it.</span></span>

<span data-ttu-id="f9d11-530">Nach dem Aufruf von Close werden alle Methodenaufrufe fehlschlagen, und die Ereignishandler werden nicht mehr ausgelöst.</span><span class="sxs-lookup"><span data-stu-id="f9d11-530">After calling Close, all method calls will fail and event handlers will stop firing.</span></span> <span data-ttu-id="f9d11-531">Insbesondere gibt die WebView Ihre Verweise auf die Ereignishandler frei, wenn Close aufgerufen wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-531">Specifically, the WebView will release its references to its event handlers when Close is called.</span></span>

<span data-ttu-id="f9d11-532">Close wird implizit aufgerufen, wenn die WebView den endgültigen Bezug verliert und zerstört wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-532">Close is implicitly called when the WebView loses its final reference and is destructed.</span></span> <span data-ttu-id="f9d11-533">Es empfiehlt sich jedoch, explizit Close aufzurufen, um einen zufälligen Zyklus von Verweisen zwischen WebView und app-Code zu vermeiden.</span><span class="sxs-lookup"><span data-stu-id="f9d11-533">But it is best practice to explicitly call Close to avoid any accidental cycle of references between the WebView and the app code.</span></span> <span data-ttu-id="f9d11-534">Insbesondere wenn Sie einen Verweis auf die WebView in einem Ereignishandler aufzeichnen, erstellen Sie einen Referenz Zyklus zwischen WebView und dem Ereignishandler.</span><span class="sxs-lookup"><span data-stu-id="f9d11-534">Specifically, if you capture a reference to the WebView in an event handler you will create a reference cycle between the WebView and the event handler.</span></span> <span data-ttu-id="f9d11-535">Schließen bricht diesen Zyklus ab, indem alle Ereignishandler freigegeben werden.</span><span class="sxs-lookup"><span data-stu-id="f9d11-535">Close will break this cycle by releasing all event handlers.</span></span> <span data-ttu-id="f9d11-536">Um diese Situation zu vermeiden, empfiehlt es sich jedoch, sowohl explizit Close für die WebView aufzurufen und keinen Verweis auf die WebView zu erfassen, um sicherzustellen, dass die WebView ordnungsgemäß bereinigt werden kann.</span><span class="sxs-lookup"><span data-stu-id="f9d11-536">But to avoid this situation it is best practice to both explicitly call Close on the WebView and to not capture a reference to the WebView to ensure the WebView can be cleaned up correctly.</span></span>
...
#### <span data-ttu-id="f9d11-537">CallDevToolsProtocolMethod</span><span class="sxs-lookup"><span data-stu-id="f9d11-537">CallDevToolsProtocolMethod</span></span> 

<span data-ttu-id="f9d11-538">Rufen Sie eine asynchrone DevToolsProtocol-Methode auf.</span><span class="sxs-lookup"><span data-stu-id="f9d11-538">Call an asynchronous DevToolsProtocol method.</span></span>

> <span data-ttu-id="f9d11-539">Public HRESULT [CallDevToolsProtocolMethod](#calldevtoolsprotocolmethod)(LPCWSTR MethodName, LPCWSTR parametersAsJson,[IWebView2CallDevToolsProtocolMethodCompletedHandler](IWebView2CallDevToolsProtocolMethodCompletedHandler.md) \* Handler)</span><span class="sxs-lookup"><span data-stu-id="f9d11-539">public HRESULT [CallDevToolsProtocolMethod](#calldevtoolsprotocolmethod)(LPCWSTR methodName,LPCWSTR parametersAsJson,[IWebView2CallDevToolsProtocolMethodCompletedHandler](IWebView2CallDevToolsProtocolMethodCompletedHandler.md) \* handler)</span></span>

<span data-ttu-id="f9d11-540">Eine Liste und eine Beschreibung der verfügbaren Methoden finden Sie im [devtools-Protokoll-Viewer](https://aka.ms/DevToolsProtocolDocs) .</span><span class="sxs-lookup"><span data-stu-id="f9d11-540">See the [DevTools Protocol Viewer](https://aka.ms/DevToolsProtocolDocs) for a list and description of available methods.</span></span> <span data-ttu-id="f9d11-541">Der MethodName-Parameter ist der vollständige Name der Methode im Format `{domain}.{method}` .</span><span class="sxs-lookup"><span data-stu-id="f9d11-541">The methodName parameter is the full name of the method in the format `{domain}.{method}`.</span></span> <span data-ttu-id="f9d11-542">Der parametersAsJson-Parameter ist eine JSON-formatierte Zeichenfolge, die die Parameter für die entsprechende Methode enthält.</span><span class="sxs-lookup"><span data-stu-id="f9d11-542">The parametersAsJson parameter is a JSON formatted string containing the parameters for the corresponding method.</span></span> <span data-ttu-id="f9d11-543">Die Invoke-Methode des Handlers wird aufgerufen, wenn die Methode asynchron abgeschlossen wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-543">The handler's Invoke method will be called when the method asynchronously completes.</span></span> <span data-ttu-id="f9d11-544">Invoke wird mit dem Rückgabeobjekt der Methode als JSON-Zeichenfolge aufgerufen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-544">Invoke will be called with the method's return object as a JSON string.</span></span>
...
#### <span data-ttu-id="f9d11-545">add_DevToolsProtocolEventReceived</span><span class="sxs-lookup"><span data-stu-id="f9d11-545">add_DevToolsProtocolEventReceived</span></span> 

<span data-ttu-id="f9d11-546">Abonnieren eines DevToolsProtocol-Ereignisses</span><span class="sxs-lookup"><span data-stu-id="f9d11-546">Subscribe to a DevToolsProtocol event.</span></span>

> <span data-ttu-id="f9d11-547">Public HRESULT [add_DevToolsProtocolEventReceived](#add_devtoolsprotocoleventreceived)(LPCWSTR EventName,[IWebView2DevToolsProtocolEventReceivedEventHandler](IWebView2DevToolsProtocolEventReceivedEventHandler.md) \* Handler, EventRegistrationToken \* Token)</span><span class="sxs-lookup"><span data-stu-id="f9d11-547">public HRESULT [add_DevToolsProtocolEventReceived](#add_devtoolsprotocoleventreceived)(LPCWSTR eventName,[IWebView2DevToolsProtocolEventReceivedEventHandler](IWebView2DevToolsProtocolEventReceivedEventHandler.md) \* handler,EventRegistrationToken \* token)</span></span>

<span data-ttu-id="f9d11-548">Eine Liste und eine Beschreibung der verfügbaren Ereignisse finden Sie im [devtools-Protokoll-Viewer](https://aka.ms/DevToolsProtocolDocs) .</span><span class="sxs-lookup"><span data-stu-id="f9d11-548">See the [DevTools Protocol Viewer](https://aka.ms/DevToolsProtocolDocs) for a list and description of available events.</span></span> <span data-ttu-id="f9d11-549">Der eventName-Parameter ist der vollständige Name des Ereignisses im Format `{domain}.{event}` .</span><span class="sxs-lookup"><span data-stu-id="f9d11-549">The eventName parameter is the full name of the event in the format `{domain}.{event}`.</span></span> <span data-ttu-id="f9d11-550">Die Invoke-Methode des Handlers wird aufgerufen, wenn das entsprechende DevToolsProtocol-Ereignis ausgelöst wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-550">The handler's Invoke method will be called whenever the corresponding DevToolsProtocol event fires.</span></span> <span data-ttu-id="f9d11-551">Invoke wird mit dem Ereignis args-Objekt aufgerufen, das das Parameter-Objekt des CDP-Ereignisses als JSON-Zeichenfolge enthält.</span><span class="sxs-lookup"><span data-stu-id="f9d11-551">Invoke will be called with the an event args object containing the CDP event's parameter object as a JSON string.</span></span>
...
#### <span data-ttu-id="f9d11-552">remove_DevToolsProtocolEventReceived</span><span class="sxs-lookup"><span data-stu-id="f9d11-552">remove_DevToolsProtocolEventReceived</span></span> 

<span data-ttu-id="f9d11-553">Entfernen Sie einen Ereignishandler, der zuvor mit add_DevToolsProtocolEventReceived hinzugefügt wurde.</span><span class="sxs-lookup"><span data-stu-id="f9d11-553">Remove an event handler previously added with add_DevToolsProtocolEventReceived.</span></span>

> <span data-ttu-id="f9d11-554">Public HRESULT [remove_DevToolsProtocolEventReceived](#remove_devtoolsprotocoleventreceived)(LPCWSTR EventName, EventRegistrationToken-Token)</span><span class="sxs-lookup"><span data-stu-id="f9d11-554">public HRESULT [remove_DevToolsProtocolEventReceived](#remove_devtoolsprotocoleventreceived)(LPCWSTR eventName,EventRegistrationToken token)</span></span>

#### <span data-ttu-id="f9d11-555">get_BrowserProcessId</span><span class="sxs-lookup"><span data-stu-id="f9d11-555">get_BrowserProcessId</span></span> 

<span data-ttu-id="f9d11-556">Die Prozess-ID des Browser Prozesses, der die WebView hostet.</span><span class="sxs-lookup"><span data-stu-id="f9d11-556">The process id of the browser process that hosts the WebView.</span></span>

> <span data-ttu-id="f9d11-557">Public HRESULT [get_BrowserProcessId](#get_browserprocessid)(UInt32 \*-Wert)</span><span class="sxs-lookup"><span data-stu-id="f9d11-557">public HRESULT [get_BrowserProcessId](#get_browserprocessid)(UINT32 \* value)</span></span>

#### <span data-ttu-id="f9d11-558">get_CanGoBack</span><span class="sxs-lookup"><span data-stu-id="f9d11-558">get_CanGoBack</span></span> 

<span data-ttu-id="f9d11-559">Kann im WebView zur vorherigen Seite im Navigationsverlauf navigieren.</span><span class="sxs-lookup"><span data-stu-id="f9d11-559">Can navigate the webview to the previous page in the navigation history.</span></span>

> <span data-ttu-id="f9d11-560">Public HRESULT [get_CanGoBack](#get_cangoback)(bool \* CanGoBack)</span><span class="sxs-lookup"><span data-stu-id="f9d11-560">public HRESULT [get_CanGoBack](#get_cangoback)(BOOL \* canGoBack)</span></span>

<span data-ttu-id="f9d11-561">get_CanGoBack ändern Sie den Wert mit dem DocumentStateChanged-Ereignis.</span><span class="sxs-lookup"><span data-stu-id="f9d11-561">get_CanGoBack change value with the DocumentStateChanged event.</span></span>

#### <span data-ttu-id="f9d11-562">get_CanGoForward</span><span class="sxs-lookup"><span data-stu-id="f9d11-562">get_CanGoForward</span></span> 

<span data-ttu-id="f9d11-563">Kann im WebView zur nächsten Seite im Navigationsverlauf navigieren.</span><span class="sxs-lookup"><span data-stu-id="f9d11-563">Can navigate the webview to the next page in the navigation history.</span></span>

> <span data-ttu-id="f9d11-564">Public HRESULT [get_CanGoForward](#get_cangoforward)(bool \* CanGoForward)</span><span class="sxs-lookup"><span data-stu-id="f9d11-564">public HRESULT [get_CanGoForward](#get_cangoforward)(BOOL \* canGoForward)</span></span>

<span data-ttu-id="f9d11-565">get_CanGoForward ändern Sie den Wert mit dem DocumentStateChanged-Ereignis.</span><span class="sxs-lookup"><span data-stu-id="f9d11-565">get_CanGoForward change value with the DocumentStateChanged event.</span></span>

#### <span data-ttu-id="f9d11-566">GoBack</span><span class="sxs-lookup"><span data-stu-id="f9d11-566">GoBack</span></span> 

<span data-ttu-id="f9d11-567">Navigiert die WebView zur vorherigen Seite im Navigationsverlauf.</span><span class="sxs-lookup"><span data-stu-id="f9d11-567">Navigates the webview to the previous page in the navigation history.</span></span>

> <span data-ttu-id="f9d11-568">Public HRESULT [GoBack](#goback)()</span><span class="sxs-lookup"><span data-stu-id="f9d11-568">public HRESULT [GoBack](#goback)()</span></span>

#### <span data-ttu-id="f9d11-569">GoForward</span><span class="sxs-lookup"><span data-stu-id="f9d11-569">GoForward</span></span> 

<span data-ttu-id="f9d11-570">Navigiert die WebView zur nächsten Seite im Navigationsverlauf.</span><span class="sxs-lookup"><span data-stu-id="f9d11-570">Navigates the webview to the next page in the navigation history.</span></span>

> <span data-ttu-id="f9d11-571">Public HRESULT [GoForward](#goforward)()</span><span class="sxs-lookup"><span data-stu-id="f9d11-571">public HRESULT [GoForward](#goforward)()</span></span>

#### <span data-ttu-id="f9d11-572">WEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT</span><span class="sxs-lookup"><span data-stu-id="f9d11-572">WEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT</span></span> 

<span data-ttu-id="f9d11-573">Bildformat, das von der [IWebView2WebView:: CapturePreview](#capturepreview) -Methode verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-573">Image format used by the [IWebView2WebView::CapturePreview](#capturepreview) method.</span></span>

> <span data-ttu-id="f9d11-574">Enum- [WEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT](#webview2_capture_preview_image_format)</span><span class="sxs-lookup"><span data-stu-id="f9d11-574">enum [WEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT](#webview2_capture_preview_image_format)</span></span>

 <span data-ttu-id="f9d11-575">Werte</span><span class="sxs-lookup"><span data-stu-id="f9d11-575">Values</span></span>                         | <span data-ttu-id="f9d11-576">Beschreibungen</span><span class="sxs-lookup"><span data-stu-id="f9d11-576">Descriptions</span></span>
--------------------------------|---------------------------------------------
<span data-ttu-id="f9d11-577">WEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT_PNG</span><span class="sxs-lookup"><span data-stu-id="f9d11-577">WEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT_PNG</span></span>            | <span data-ttu-id="f9d11-578">PNG-Bildformat.</span><span class="sxs-lookup"><span data-stu-id="f9d11-578">PNG image format.</span></span>
<span data-ttu-id="f9d11-579">WEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT_JPEG</span><span class="sxs-lookup"><span data-stu-id="f9d11-579">WEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT_JPEG</span></span>            | <span data-ttu-id="f9d11-580">JPEG-Bildformat.</span><span class="sxs-lookup"><span data-stu-id="f9d11-580">JPEG image format.</span></span>

#### <span data-ttu-id="f9d11-581">WEBVIEW2_SCRIPT_DIALOG_KIND</span><span class="sxs-lookup"><span data-stu-id="f9d11-581">WEBVIEW2_SCRIPT_DIALOG_KIND</span></span> 

<span data-ttu-id="f9d11-582">Art des in der [IWebView2ScriptDialogOpeningEventHandler](IWebView2ScriptDialogOpeningEventHandler.md) -Schnittstelle verwendeten JavaScript-Dialogfelds.</span><span class="sxs-lookup"><span data-stu-id="f9d11-582">Kind of JavaScript dialog used in the [IWebView2ScriptDialogOpeningEventHandler](IWebView2ScriptDialogOpeningEventHandler.md) interface.</span></span>

> <span data-ttu-id="f9d11-583">Enum- [WEBVIEW2_SCRIPT_DIALOG_KIND](#webview2_script_dialog_kind)</span><span class="sxs-lookup"><span data-stu-id="f9d11-583">enum [WEBVIEW2_SCRIPT_DIALOG_KIND](#webview2_script_dialog_kind)</span></span>

 <span data-ttu-id="f9d11-584">Werte</span><span class="sxs-lookup"><span data-stu-id="f9d11-584">Values</span></span>                         | <span data-ttu-id="f9d11-585">Beschreibungen</span><span class="sxs-lookup"><span data-stu-id="f9d11-585">Descriptions</span></span>
--------------------------------|---------------------------------------------
<span data-ttu-id="f9d11-586">WEBVIEW2_SCRIPT_DIALOG_KIND_ALERT</span><span class="sxs-lookup"><span data-stu-id="f9d11-586">WEBVIEW2_SCRIPT_DIALOG_KIND_ALERT</span></span>            | <span data-ttu-id="f9d11-587">Ein Dialogfeld, das über die JavaScript-Funktion "Window. Alert" aufgerufen wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-587">A dialog invoked via the window.alert JavaScript function.</span></span>
<span data-ttu-id="f9d11-588">WEBVIEW2_SCRIPT_DIALOG_KIND_CONFIRM</span><span class="sxs-lookup"><span data-stu-id="f9d11-588">WEBVIEW2_SCRIPT_DIALOG_KIND_CONFIRM</span></span>            | <span data-ttu-id="f9d11-589">Ein Dialogfeld, das über die JavaScript-Funktion "Fenster. bestätigen" aufgerufen wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-589">A dialog invoked via the window.confirm JavaScript function.</span></span>
<span data-ttu-id="f9d11-590">WEBVIEW2_SCRIPT_DIALOG_KIND_PROMPT</span><span class="sxs-lookup"><span data-stu-id="f9d11-590">WEBVIEW2_SCRIPT_DIALOG_KIND_PROMPT</span></span>            | <span data-ttu-id="f9d11-591">Ein Dialogfeld, das über die JavaScript-Funktion "Window. prompt" aufgerufen wird.</span><span class="sxs-lookup"><span data-stu-id="f9d11-591">A dialog invoked via the window.prompt JavaScript function.</span></span>

#### <span data-ttu-id="f9d11-592">WEBVIEW2_PROCESS_FAILED_KIND</span><span class="sxs-lookup"><span data-stu-id="f9d11-592">WEBVIEW2_PROCESS_FAILED_KIND</span></span> 

<span data-ttu-id="f9d11-593">Art des in der [IWebView2ProcessFailedEventHandler](IWebView2ProcessFailedEventHandler.md) -Schnittstelle verwendeten Prozess Fehlers.</span><span class="sxs-lookup"><span data-stu-id="f9d11-593">Kind of process failure used in the [IWebView2ProcessFailedEventHandler](IWebView2ProcessFailedEventHandler.md) interface.</span></span>

> <span data-ttu-id="f9d11-594">Enum- [WEBVIEW2_PROCESS_FAILED_KIND](#webview2_process_failed_kind)</span><span class="sxs-lookup"><span data-stu-id="f9d11-594">enum [WEBVIEW2_PROCESS_FAILED_KIND](#webview2_process_failed_kind)</span></span>

 <span data-ttu-id="f9d11-595">Werte</span><span class="sxs-lookup"><span data-stu-id="f9d11-595">Values</span></span>                         | <span data-ttu-id="f9d11-596">Beschreibungen</span><span class="sxs-lookup"><span data-stu-id="f9d11-596">Descriptions</span></span>
--------------------------------|---------------------------------------------
<span data-ttu-id="f9d11-597">WEBVIEW2_PROCESS_FAILED_KIND_BROWSER_PROCESS_EXITED</span><span class="sxs-lookup"><span data-stu-id="f9d11-597">WEBVIEW2_PROCESS_FAILED_KIND_BROWSER_PROCESS_EXITED</span></span>            | <span data-ttu-id="f9d11-598">Gibt an, dass der Browserprozess unerwartet beendet wurde.</span><span class="sxs-lookup"><span data-stu-id="f9d11-598">Indicates the browser process terminated unexpectedly.</span></span>
<span data-ttu-id="f9d11-599">WEBVIEW2_PROCESS_FAILED_KIND_RENDER_PROCESS_EXITED</span><span class="sxs-lookup"><span data-stu-id="f9d11-599">WEBVIEW2_PROCESS_FAILED_KIND_RENDER_PROCESS_EXITED</span></span>            | <span data-ttu-id="f9d11-600">Gibt an, dass der Renderprozess unerwartet beendet wurde.</span><span class="sxs-lookup"><span data-stu-id="f9d11-600">Indicates the render process terminated unexpectedly.</span></span>
<span data-ttu-id="f9d11-601">WEBVIEW2_PROCESS_FAILED_KIND_RENDER_PROCESS_UNRESPONSIVE</span><span class="sxs-lookup"><span data-stu-id="f9d11-601">WEBVIEW2_PROCESS_FAILED_KIND_RENDER_PROCESS_UNRESPONSIVE</span></span>            | <span data-ttu-id="f9d11-602">Gibt an, dass der Renderprozess nicht mehr reagiert.</span><span class="sxs-lookup"><span data-stu-id="f9d11-602">Indicates the render process becomes unresponsive.</span></span>

#### <span data-ttu-id="f9d11-603">WEBVIEW2_PERMISSION_TYPE</span><span class="sxs-lookup"><span data-stu-id="f9d11-603">WEBVIEW2_PERMISSION_TYPE</span></span> 

<span data-ttu-id="f9d11-604">Der Typ einer Berechtigungsanforderung.</span><span class="sxs-lookup"><span data-stu-id="f9d11-604">The type of a permission request.</span></span>

> <span data-ttu-id="f9d11-605">Enum- [WEBVIEW2_PERMISSION_TYPE](#webview2_permission_type)</span><span class="sxs-lookup"><span data-stu-id="f9d11-605">enum [WEBVIEW2_PERMISSION_TYPE](#webview2_permission_type)</span></span>

 <span data-ttu-id="f9d11-606">Werte</span><span class="sxs-lookup"><span data-stu-id="f9d11-606">Values</span></span>                         | <span data-ttu-id="f9d11-607">Beschreibungen</span><span class="sxs-lookup"><span data-stu-id="f9d11-607">Descriptions</span></span>
--------------------------------|---------------------------------------------
<span data-ttu-id="f9d11-608">WEBVIEW2_PERMISSION_TYPE_UNKNOWN_PERMISSION</span><span class="sxs-lookup"><span data-stu-id="f9d11-608">WEBVIEW2_PERMISSION_TYPE_UNKNOWN_PERMISSION</span></span>            | <span data-ttu-id="f9d11-609">Unbekannte Berechtigung.</span><span class="sxs-lookup"><span data-stu-id="f9d11-609">Unknown permission.</span></span>
<span data-ttu-id="f9d11-610">WEBVIEW2_PERMISSION_TYPE_MICROPHONE</span><span class="sxs-lookup"><span data-stu-id="f9d11-610">WEBVIEW2_PERMISSION_TYPE_MICROPHONE</span></span>            | <span data-ttu-id="f9d11-611">Berechtigung zum Aufzeichnen von Audio.</span><span class="sxs-lookup"><span data-stu-id="f9d11-611">Permission to capture audio.</span></span>
<span data-ttu-id="f9d11-612">WEBVIEW2_PERMISSION_TYPE_CAMERA</span><span class="sxs-lookup"><span data-stu-id="f9d11-612">WEBVIEW2_PERMISSION_TYPE_CAMERA</span></span>            | <span data-ttu-id="f9d11-613">Berechtigung zum Aufzeichnen von Videos.</span><span class="sxs-lookup"><span data-stu-id="f9d11-613">Permission to capture video.</span></span>
<span data-ttu-id="f9d11-614">WEBVIEW2_PERMISSION_TYPE_GEOLOCATION</span><span class="sxs-lookup"><span data-stu-id="f9d11-614">WEBVIEW2_PERMISSION_TYPE_GEOLOCATION</span></span>            | <span data-ttu-id="f9d11-615">Berechtigung für den Zugriff auf Geolocation.</span><span class="sxs-lookup"><span data-stu-id="f9d11-615">Permission to access geolocation.</span></span>
<span data-ttu-id="f9d11-616">WEBVIEW2_PERMISSION_TYPE_NOTIFICATIONS</span><span class="sxs-lookup"><span data-stu-id="f9d11-616">WEBVIEW2_PERMISSION_TYPE_NOTIFICATIONS</span></span>            | <span data-ttu-id="f9d11-617">Berechtigung zum Senden von webbenachrichtigungen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-617">Permission to send web notifications.</span></span>
<span data-ttu-id="f9d11-618">WEBVIEW2_PERMISSION_TYPE_OTHER_SENSORS</span><span class="sxs-lookup"><span data-stu-id="f9d11-618">WEBVIEW2_PERMISSION_TYPE_OTHER_SENSORS</span></span>            | <span data-ttu-id="f9d11-619">Berechtigung für den Zugriff auf den generischen Sensor.</span><span class="sxs-lookup"><span data-stu-id="f9d11-619">Permission to access generic sensor.</span></span>
<span data-ttu-id="f9d11-620">WEBVIEW2_PERMISSION_TYPE_CLIPBOARD_READ</span><span class="sxs-lookup"><span data-stu-id="f9d11-620">WEBVIEW2_PERMISSION_TYPE_CLIPBOARD_READ</span></span>            | <span data-ttu-id="f9d11-621">Berechtigung zum Lesen der Systemzwischenablage ohne Benutzergeste</span><span class="sxs-lookup"><span data-stu-id="f9d11-621">Permission to read system clipboard without a user gesture.</span></span>

#### <span data-ttu-id="f9d11-622">WEBVIEW2_PERMISSION_STATE</span><span class="sxs-lookup"><span data-stu-id="f9d11-622">WEBVIEW2_PERMISSION_STATE</span></span> 

<span data-ttu-id="f9d11-623">Antwort auf eine Berechtigungsanforderung.</span><span class="sxs-lookup"><span data-stu-id="f9d11-623">Response to a permission request.</span></span>

> <span data-ttu-id="f9d11-624">Enum- [WEBVIEW2_PERMISSION_STATE](#webview2_permission_state)</span><span class="sxs-lookup"><span data-stu-id="f9d11-624">enum [WEBVIEW2_PERMISSION_STATE](#webview2_permission_state)</span></span>

 <span data-ttu-id="f9d11-625">Werte</span><span class="sxs-lookup"><span data-stu-id="f9d11-625">Values</span></span>                         | <span data-ttu-id="f9d11-626">Beschreibungen</span><span class="sxs-lookup"><span data-stu-id="f9d11-626">Descriptions</span></span>
--------------------------------|---------------------------------------------
<span data-ttu-id="f9d11-627">WEBVIEW2_PERMISSION_STATE_DEFAULT</span><span class="sxs-lookup"><span data-stu-id="f9d11-627">WEBVIEW2_PERMISSION_STATE_DEFAULT</span></span>            | <span data-ttu-id="f9d11-628">Verwenden Sie das Standardbrowser Verhalten, das die Benutzer normalerweise zur Entscheidung auffordert.</span><span class="sxs-lookup"><span data-stu-id="f9d11-628">Use default browser behavior, which normally prompt users for decision.</span></span>
<span data-ttu-id="f9d11-629">WEBVIEW2_PERMISSION_STATE_ALLOW</span><span class="sxs-lookup"><span data-stu-id="f9d11-629">WEBVIEW2_PERMISSION_STATE_ALLOW</span></span>            | <span data-ttu-id="f9d11-630">Erteilen Sie die Berechtigungsanforderung.</span><span class="sxs-lookup"><span data-stu-id="f9d11-630">Grant the permission request.</span></span>
<span data-ttu-id="f9d11-631">WEBVIEW2_PERMISSION_STATE_DENY</span><span class="sxs-lookup"><span data-stu-id="f9d11-631">WEBVIEW2_PERMISSION_STATE_DENY</span></span>            | <span data-ttu-id="f9d11-632">Verweigern Sie die Berechtigungsanforderung.</span><span class="sxs-lookup"><span data-stu-id="f9d11-632">Deny the permission request.</span></span>

#### <span data-ttu-id="f9d11-633">WEBVIEW2_MOVE_FOCUS_REASON</span><span class="sxs-lookup"><span data-stu-id="f9d11-633">WEBVIEW2_MOVE_FOCUS_REASON</span></span> 

<span data-ttu-id="f9d11-634">Grund für das Verschieben des Fokus</span><span class="sxs-lookup"><span data-stu-id="f9d11-634">Reason for moving focus.</span></span>

> <span data-ttu-id="f9d11-635">Enum- [WEBVIEW2_MOVE_FOCUS_REASON](#webview2_move_focus_reason)</span><span class="sxs-lookup"><span data-stu-id="f9d11-635">enum [WEBVIEW2_MOVE_FOCUS_REASON](#webview2_move_focus_reason)</span></span>

 <span data-ttu-id="f9d11-636">Werte</span><span class="sxs-lookup"><span data-stu-id="f9d11-636">Values</span></span>                         | <span data-ttu-id="f9d11-637">Beschreibungen</span><span class="sxs-lookup"><span data-stu-id="f9d11-637">Descriptions</span></span>
--------------------------------|---------------------------------------------
<span data-ttu-id="f9d11-638">WEBVIEW2_MOVE_FOCUS_REASON_PROGRAMMATIC</span><span class="sxs-lookup"><span data-stu-id="f9d11-638">WEBVIEW2_MOVE_FOCUS_REASON_PROGRAMMATIC</span></span>            | <span data-ttu-id="f9d11-639">Der Fokus für die Code Einstellung in WebView.</span><span class="sxs-lookup"><span data-stu-id="f9d11-639">Code setting focus into WebView.</span></span>
<span data-ttu-id="f9d11-640">WEBVIEW2_MOVE_FOCUS_REASON_NEXT</span><span class="sxs-lookup"><span data-stu-id="f9d11-640">WEBVIEW2_MOVE_FOCUS_REASON_NEXT</span></span>            | <span data-ttu-id="f9d11-641">Verschieben des Fokus aufgrund von Tabstopps vorwärts</span><span class="sxs-lookup"><span data-stu-id="f9d11-641">Moving focus due to Tab traversal forward.</span></span>
<span data-ttu-id="f9d11-642">WEBVIEW2_MOVE_FOCUS_REASON_PREVIOUS</span><span class="sxs-lookup"><span data-stu-id="f9d11-642">WEBVIEW2_MOVE_FOCUS_REASON_PREVIOUS</span></span>            | <span data-ttu-id="f9d11-643">Verschieben des Fokus aufgrund von Tabstopps rückwärts</span><span class="sxs-lookup"><span data-stu-id="f9d11-643">Moving focus due to Tab traversal backward.</span></span>

#### <span data-ttu-id="f9d11-644">WEBVIEW2_WEB_ERROR_STATUS</span><span class="sxs-lookup"><span data-stu-id="f9d11-644">WEBVIEW2_WEB_ERROR_STATUS</span></span> 

<span data-ttu-id="f9d11-645">Fehlerstatus Werte für Web-Navigationselemente.</span><span class="sxs-lookup"><span data-stu-id="f9d11-645">Error status values for web navigations.</span></span>

> <span data-ttu-id="f9d11-646">Enum- [WEBVIEW2_WEB_ERROR_STATUS](#webview2_web_error_status)</span><span class="sxs-lookup"><span data-stu-id="f9d11-646">enum [WEBVIEW2_WEB_ERROR_STATUS](#webview2_web_error_status)</span></span>

 <span data-ttu-id="f9d11-647">Werte</span><span class="sxs-lookup"><span data-stu-id="f9d11-647">Values</span></span>                         | <span data-ttu-id="f9d11-648">Beschreibungen</span><span class="sxs-lookup"><span data-stu-id="f9d11-648">Descriptions</span></span>
--------------------------------|---------------------------------------------
<span data-ttu-id="f9d11-649">WEBVIEW2_WEB_ERROR_STATUS_UNKNOWN</span><span class="sxs-lookup"><span data-stu-id="f9d11-649">WEBVIEW2_WEB_ERROR_STATUS_UNKNOWN</span></span>            | <span data-ttu-id="f9d11-650">Ein unbekannter Fehler ist aufgetreten.</span><span class="sxs-lookup"><span data-stu-id="f9d11-650">An unknown error occurred.</span></span>
<span data-ttu-id="f9d11-651">WEBVIEW2_WEB_ERROR_STATUS_CERTIFICATE_COMMON_NAME_IS_INCORRECT</span><span class="sxs-lookup"><span data-stu-id="f9d11-651">WEBVIEW2_WEB_ERROR_STATUS_CERTIFICATE_COMMON_NAME_IS_INCORRECT</span></span>            | <span data-ttu-id="f9d11-652">Der allgemeine Name des SSL-Zertifikats entspricht nicht der Webadresse.</span><span class="sxs-lookup"><span data-stu-id="f9d11-652">The SSL certificate common name does not match the web address.</span></span>
<span data-ttu-id="f9d11-653">WEBVIEW2_WEB_ERROR_STATUS_CERTIFICATE_EXPIRED</span><span class="sxs-lookup"><span data-stu-id="f9d11-653">WEBVIEW2_WEB_ERROR_STATUS_CERTIFICATE_EXPIRED</span></span>            | <span data-ttu-id="f9d11-654">Das SSL-Zertifikat ist abgelaufen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-654">The SSL certificate has expired.</span></span>
<span data-ttu-id="f9d11-655">WEBVIEW2_WEB_ERROR_STATUS_CLIENT_CERTIFICATE_CONTAINS_ERRORS</span><span class="sxs-lookup"><span data-stu-id="f9d11-655">WEBVIEW2_WEB_ERROR_STATUS_CLIENT_CERTIFICATE_CONTAINS_ERRORS</span></span>            | <span data-ttu-id="f9d11-656">Das SSL-Clientzertifikat enthält Fehler.</span><span class="sxs-lookup"><span data-stu-id="f9d11-656">The SSL client certificate contains errors.</span></span>
<span data-ttu-id="f9d11-657">WEBVIEW2_WEB_ERROR_STATUS_CERTIFICATE_REVOKED</span><span class="sxs-lookup"><span data-stu-id="f9d11-657">WEBVIEW2_WEB_ERROR_STATUS_CERTIFICATE_REVOKED</span></span>            | <span data-ttu-id="f9d11-658">Das SSL-Zertifikat wurde gesperrt.</span><span class="sxs-lookup"><span data-stu-id="f9d11-658">The SSL certificate has been revoked.</span></span>
<span data-ttu-id="f9d11-659">WEBVIEW2_WEB_ERROR_STATUS_CERTIFICATE_IS_INVALID</span><span class="sxs-lookup"><span data-stu-id="f9d11-659">WEBVIEW2_WEB_ERROR_STATUS_CERTIFICATE_IS_INVALID</span></span>            | <span data-ttu-id="f9d11-660">Das SSL-Zertifikat ist ungültig.</span><span class="sxs-lookup"><span data-stu-id="f9d11-660">The SSL certificate is invalid.</span></span>
<span data-ttu-id="f9d11-661">WEBVIEW2_WEB_ERROR_STATUS_SERVER_UNREACHABLE</span><span class="sxs-lookup"><span data-stu-id="f9d11-661">WEBVIEW2_WEB_ERROR_STATUS_SERVER_UNREACHABLE</span></span>            | <span data-ttu-id="f9d11-662">Der Host ist nicht erreichbar.</span><span class="sxs-lookup"><span data-stu-id="f9d11-662">The host is unreachable.</span></span>
<span data-ttu-id="f9d11-663">WEBVIEW2_WEB_ERROR_STATUS_TIMEOUT</span><span class="sxs-lookup"><span data-stu-id="f9d11-663">WEBVIEW2_WEB_ERROR_STATUS_TIMEOUT</span></span>            | <span data-ttu-id="f9d11-664">Die Verbindung hat ein Zeitlimit überschritten.</span><span class="sxs-lookup"><span data-stu-id="f9d11-664">The connection has timed out.</span></span>
<span data-ttu-id="f9d11-665">WEBVIEW2_WEB_ERROR_STATUS_ERROR_HTTP_INVALID_SERVER_RESPONSE</span><span class="sxs-lookup"><span data-stu-id="f9d11-665">WEBVIEW2_WEB_ERROR_STATUS_ERROR_HTTP_INVALID_SERVER_RESPONSE</span></span>            | <span data-ttu-id="f9d11-666">Der Server hat eine ungültige oder unbekannte Antwort zurückgegeben.</span><span class="sxs-lookup"><span data-stu-id="f9d11-666">The server returned an invalid or unrecognized response.</span></span>
<span data-ttu-id="f9d11-667">WEBVIEW2_WEB_ERROR_STATUS_CONNECTION_ABORTED</span><span class="sxs-lookup"><span data-stu-id="f9d11-667">WEBVIEW2_WEB_ERROR_STATUS_CONNECTION_ABORTED</span></span>            | <span data-ttu-id="f9d11-668">Die Verbindung wurde abgebrochen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-668">The connection was aborted.</span></span>
<span data-ttu-id="f9d11-669">WEBVIEW2_WEB_ERROR_STATUS_CONNECTION_RESET</span><span class="sxs-lookup"><span data-stu-id="f9d11-669">WEBVIEW2_WEB_ERROR_STATUS_CONNECTION_RESET</span></span>            | <span data-ttu-id="f9d11-670">Die Verbindung wurde zurückgesetzt.</span><span class="sxs-lookup"><span data-stu-id="f9d11-670">The connection was reset.</span></span>
<span data-ttu-id="f9d11-671">WEBVIEW2_WEB_ERROR_STATUS_DISCONNECTED</span><span class="sxs-lookup"><span data-stu-id="f9d11-671">WEBVIEW2_WEB_ERROR_STATUS_DISCONNECTED</span></span>            | <span data-ttu-id="f9d11-672">Die Internet Verbindung wurde unterbrochen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-672">The Internet connection has been lost.</span></span>
<span data-ttu-id="f9d11-673">WEBVIEW2_WEB_ERROR_STATUS_CANNOT_CONNECT</span><span class="sxs-lookup"><span data-stu-id="f9d11-673">WEBVIEW2_WEB_ERROR_STATUS_CANNOT_CONNECT</span></span>            | <span data-ttu-id="f9d11-674">Verbindung mit Ziel kann nicht hergestellt werden.</span><span class="sxs-lookup"><span data-stu-id="f9d11-674">Cannot connect to destination.</span></span>
<span data-ttu-id="f9d11-675">WEBVIEW2_WEB_ERROR_STATUS_HOST_NAME_NOT_RESOLVED</span><span class="sxs-lookup"><span data-stu-id="f9d11-675">WEBVIEW2_WEB_ERROR_STATUS_HOST_NAME_NOT_RESOLVED</span></span>            | <span data-ttu-id="f9d11-676">Der angegebene Hostname konnte nicht aufgelöst werden.</span><span class="sxs-lookup"><span data-stu-id="f9d11-676">Could not resolve provided host name.</span></span>
<span data-ttu-id="f9d11-677">WEBVIEW2_WEB_ERROR_STATUS_OPERATION_CANCELED</span><span class="sxs-lookup"><span data-stu-id="f9d11-677">WEBVIEW2_WEB_ERROR_STATUS_OPERATION_CANCELED</span></span>            | <span data-ttu-id="f9d11-678">Der Vorgang wurde abgebrochen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-678">The operation was canceled.</span></span>
<span data-ttu-id="f9d11-679">WEBVIEW2_WEB_ERROR_STATUS_REDIRECT_FAILED</span><span class="sxs-lookup"><span data-stu-id="f9d11-679">WEBVIEW2_WEB_ERROR_STATUS_REDIRECT_FAILED</span></span>            | <span data-ttu-id="f9d11-680">Die Anforderungs Umleitung ist fehlgeschlagen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-680">The request redirect failed.</span></span>
<span data-ttu-id="f9d11-681">WEBVIEW2_WEB_ERROR_STATUS_UNEXPECTED_ERROR</span><span class="sxs-lookup"><span data-stu-id="f9d11-681">WEBVIEW2_WEB_ERROR_STATUS_UNEXPECTED_ERROR</span></span>            | <span data-ttu-id="f9d11-682">Ein unerwarteter Fehler ist aufgetreten.</span><span class="sxs-lookup"><span data-stu-id="f9d11-682">An unexpected error occurred.</span></span>

#### <span data-ttu-id="f9d11-683">WEBVIEW2_WEB_RESOURCE_CONTEXT</span><span class="sxs-lookup"><span data-stu-id="f9d11-683">WEBVIEW2_WEB_RESOURCE_CONTEXT</span></span> 

<span data-ttu-id="f9d11-684">Enum für Webressourcen-anforderungskontexte.</span><span class="sxs-lookup"><span data-stu-id="f9d11-684">Enum for web resource request contexts.</span></span>

> <span data-ttu-id="f9d11-685">Enum- [WEBVIEW2_WEB_RESOURCE_CONTEXT](#webview2_web_resource_context)</span><span class="sxs-lookup"><span data-stu-id="f9d11-685">enum [WEBVIEW2_WEB_RESOURCE_CONTEXT](#webview2_web_resource_context)</span></span>

 <span data-ttu-id="f9d11-686">Werte</span><span class="sxs-lookup"><span data-stu-id="f9d11-686">Values</span></span>                         | <span data-ttu-id="f9d11-687">Beschreibungen</span><span class="sxs-lookup"><span data-stu-id="f9d11-687">Descriptions</span></span>
--------------------------------|---------------------------------------------
<span data-ttu-id="f9d11-688">WEBVIEW2_WEB_RESOURCE_CONTEXT_ALL</span><span class="sxs-lookup"><span data-stu-id="f9d11-688">WEBVIEW2_WEB_RESOURCE_CONTEXT_ALL</span></span>            | <span data-ttu-id="f9d11-689">Alle Ressourcen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-689">All resources.</span></span>
<span data-ttu-id="f9d11-690">WEBVIEW2_WEB_RESOURCE_CONTEXT_DOCUMENT</span><span class="sxs-lookup"><span data-stu-id="f9d11-690">WEBVIEW2_WEB_RESOURCE_CONTEXT_DOCUMENT</span></span>            | <span data-ttu-id="f9d11-691">Dokument Ressourcen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-691">Document resources.</span></span>
<span data-ttu-id="f9d11-692">WEBVIEW2_WEB_RESOURCE_CONTEXT_STYLESHEET</span><span class="sxs-lookup"><span data-stu-id="f9d11-692">WEBVIEW2_WEB_RESOURCE_CONTEXT_STYLESHEET</span></span>            | <span data-ttu-id="f9d11-693">CSS-Ressourcen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-693">CSS resources.</span></span>
<span data-ttu-id="f9d11-694">WEBVIEW2_WEB_RESOURCE_CONTEXT_IMAGE</span><span class="sxs-lookup"><span data-stu-id="f9d11-694">WEBVIEW2_WEB_RESOURCE_CONTEXT_IMAGE</span></span>            | <span data-ttu-id="f9d11-695">Bildressourcen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-695">Image resources.</span></span>
<span data-ttu-id="f9d11-696">WEBVIEW2_WEB_RESOURCE_CONTEXT_MEDIA</span><span class="sxs-lookup"><span data-stu-id="f9d11-696">WEBVIEW2_WEB_RESOURCE_CONTEXT_MEDIA</span></span>            | <span data-ttu-id="f9d11-697">Andere Medienressourcen wie Videos.</span><span class="sxs-lookup"><span data-stu-id="f9d11-697">Other media resources such as videos.</span></span>
<span data-ttu-id="f9d11-698">WEBVIEW2_WEB_RESOURCE_CONTEXT_FONT</span><span class="sxs-lookup"><span data-stu-id="f9d11-698">WEBVIEW2_WEB_RESOURCE_CONTEXT_FONT</span></span>            | <span data-ttu-id="f9d11-699">Schriftartressourcen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-699">Font resources.</span></span>
<span data-ttu-id="f9d11-700">WEBVIEW2_WEB_RESOURCE_CONTEXT_SCRIPT</span><span class="sxs-lookup"><span data-stu-id="f9d11-700">WEBVIEW2_WEB_RESOURCE_CONTEXT_SCRIPT</span></span>            | <span data-ttu-id="f9d11-701">Skriptressourcen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-701">Script resources.</span></span>
<span data-ttu-id="f9d11-702">WEBVIEW2_WEB_RESOURCE_CONTEXT_XML_HTTP_REQUEST</span><span class="sxs-lookup"><span data-stu-id="f9d11-702">WEBVIEW2_WEB_RESOURCE_CONTEXT_XML_HTTP_REQUEST</span></span>            | <span data-ttu-id="f9d11-703">XML-HTTP-Anforderungen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-703">XML HTTP requests.</span></span>
<span data-ttu-id="f9d11-704">WEBVIEW2_WEB_RESOURCE_CONTEXT_FETCH</span><span class="sxs-lookup"><span data-stu-id="f9d11-704">WEBVIEW2_WEB_RESOURCE_CONTEXT_FETCH</span></span>            | <span data-ttu-id="f9d11-705">Abrufen der API-Kommunikation.</span><span class="sxs-lookup"><span data-stu-id="f9d11-705">Fetch API communication.</span></span>
<span data-ttu-id="f9d11-706">WEBVIEW2_WEB_RESOURCE_CONTEXT_TEXT_TRACK</span><span class="sxs-lookup"><span data-stu-id="f9d11-706">WEBVIEW2_WEB_RESOURCE_CONTEXT_TEXT_TRACK</span></span>            | <span data-ttu-id="f9d11-707">Texttracking-Ressourcen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-707">TextTrack resources.</span></span>
<span data-ttu-id="f9d11-708">WEBVIEW2_WEB_RESOURCE_CONTEXT_EVENT_SOURCE</span><span class="sxs-lookup"><span data-stu-id="f9d11-708">WEBVIEW2_WEB_RESOURCE_CONTEXT_EVENT_SOURCE</span></span>            | 
<span data-ttu-id="f9d11-709">WEBVIEW2_WEB_RESOURCE_CONTEXT_WEBSOCKET</span><span class="sxs-lookup"><span data-stu-id="f9d11-709">WEBVIEW2_WEB_RESOURCE_CONTEXT_WEBSOCKET</span></span>            | 
<span data-ttu-id="f9d11-710">WEBVIEW2_WEB_RESOURCE_CONTEXT_MANIFEST</span><span class="sxs-lookup"><span data-stu-id="f9d11-710">WEBVIEW2_WEB_RESOURCE_CONTEXT_MANIFEST</span></span>            | 
<span data-ttu-id="f9d11-711">WEBVIEW2_WEB_RESOURCE_CONTEXT_SIGNED_EXCHANGE</span><span class="sxs-lookup"><span data-stu-id="f9d11-711">WEBVIEW2_WEB_RESOURCE_CONTEXT_SIGNED_EXCHANGE</span></span>            | 
<span data-ttu-id="f9d11-712">WEBVIEW2_WEB_RESOURCE_CONTEXT_PING</span><span class="sxs-lookup"><span data-stu-id="f9d11-712">WEBVIEW2_WEB_RESOURCE_CONTEXT_PING</span></span>            | 
<span data-ttu-id="f9d11-713">WEBVIEW2_WEB_RESOURCE_CONTEXT_CSP_VIOLATION_REPORT</span><span class="sxs-lookup"><span data-stu-id="f9d11-713">WEBVIEW2_WEB_RESOURCE_CONTEXT_CSP_VIOLATION_REPORT</span></span>            | 
<span data-ttu-id="f9d11-714">WEBVIEW2_WEB_RESOURCE_CONTEXT_OTHER</span><span class="sxs-lookup"><span data-stu-id="f9d11-714">WEBVIEW2_WEB_RESOURCE_CONTEXT_OTHER</span></span>            | <span data-ttu-id="f9d11-715">Andere Ressourcen.</span><span class="sxs-lookup"><span data-stu-id="f9d11-715">Other resources.</span></span>
