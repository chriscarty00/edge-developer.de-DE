...
*   Weitere Informationen zum Erstellen von WPF-Apps finden Sie im [WPF Get Started Guide][Webview2GetStartedWpf] und in der WebView2-WPF-Referenz für WPF-spezifische APIs. [][DotnetApiMicrosoftWebWebview2Wpf]  
*   Weitere Informationen zum Erstellen von Windows Forms-Apps finden Sie im [Windows Forms Get Started Guide][Webview2GetStartedWinforms] und in der WebView2 Windows Forms [Reference][DotnetApiMicrosoftWebWebview2Winforms] for Windows Forms specific APIs.  
