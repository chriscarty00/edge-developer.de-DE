...
Zur Nutzung der fortschrittlichsten Funktionen in der Peer-to-Peer-Audio-und Videokommunikation empfehlen wir die Verwendung der [API für Objekt Real-Time Kommunikation)](https://ortc.org).  Die ORTC-API eignet sich besser für Situationen, in denen Sie Gruppen-Audio-und Videoanrufe einrichten oder einzelne Transport-, Absender-und Empfängerobjekte direkt steuern möchten.  
...
:::row:::
   ...
   :::column-end:::
   :::column span="2":::
      `base-uri`, `child-src` , `form-action` und `frame-ancestors` `plugin-types` .  <!--  See [Microsoft Edge supported CSP directives](../security/content-security-policy.md) for more.  -->  
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="1":::
...
Die Microsoft Edge-Unterstützung für die neue **Webauthentifizierungs-API** mit [Windows Hello](https://www.microsoft.com/windows/comprehensive-security) Biometrie wurde mit den folgenden Änderungen aktualisiert:  
...
Weitere Informationen und den Status anderer WebDriver-Features finden Sie unter [WebDriver](../../webdriver/index.md).  
