...
| - | - | - | - | - | - | - | - | - | - | - |  
| **Einfach** | - | - | - | B | B | - | - | Aktiviert | n.v. |  
| **Ausgeglichen** | S | - | S | B | B | S | S | Aktiviert | Aktiviert |  
...
1.  Wenn Sie feststellen möchten, in welcher Kategorie sich eine bestimmte blockierte Website befindet, ist es am einfachsten, wenn Sie in der [Liste Disconnect Services. JSON][GitHubDisconnectTrackingProtectionCategories]danach suchen.  Da die Einträge alphabetisch sortiert sind, können Sie durch Scrollen an den Anfang eines Blocks von Website Einträgen die spezifische Kategorie für eine bestimmte Website finden.  
